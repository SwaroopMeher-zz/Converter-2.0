...
Reads Darknet config and weights and creates Keras model with TF backend.
    command : python convert2.py darknet53.cfg darknet53.weights darknet53.h5
"""
...
from tensorflow.python.keras.layers import (Conv2D, Input, ZeroPadding2D, Add,
                                            UpSampling2D, MaxPooling2D, Concatenate, AveragePooling2D)
...
def _main(args):
    ...
    for section in cfg_parser.sections():
        ...
        if section.startswith('convolutional'):
            ...
            all_layers.append(AveragePooling2D(pool_size=(prev_layer.shape[1], prev_layer.shape[2]))(prev_layer))
            prev_layer = all_layers[-1]
